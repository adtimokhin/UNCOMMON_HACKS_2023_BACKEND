  ...
  return (
    <Paper className={classes.paper}>
      <form autoComplete="off" noValidate className={`${classes.root} ${classes.form}`} onSubmit={handleSubmit}>
        ...
        <TextField name="creator" variant="outlined" label="Department/Club" fullWidth value={postData.creator} onChange={(e) => setPostData({ ...postData, creator: e.target.value })} />
        ...
        <TextField
          ...
          onChange={(e) => setPostData({ ...postData, eventTime: e.target.value })}
        />
        <TextField name="eventLocation" variant="outlined" label="Location" fullWidth multiline rows={1} value={postData.eventLocation} onChange={(e) => setPostData({ ...postData, eventLocation: e.target.value })} />
        <TextField name="tags" variant="outlined" label="Tags (coma separated,no spaces adjacent to commas)" fullWidth value={postData.tags} onChange={(e) => setPostData({ ...postData, tags: e.target.value.split(',') })} />
